...
io.sockets.on('connection', (socket) => {
  ...
  socket.on('click', (tweet)=>{
    SearchTermData(tweet, 50);
    tweet = 'works';
    socket.broadcast.emit('click', tweet);
  });
});
